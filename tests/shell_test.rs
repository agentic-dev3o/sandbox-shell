...
use sx::shell::integration::{
    generate_zsh_integration, generate_bash_integration, generate_fish_integration, ShellType,
};
...
fn test_shell_type_detect_fish() {
    ...
    assert_eq!(ShellType::from_path("/opt/homebrew/bin/fish"), ShellType::Fish);
}
